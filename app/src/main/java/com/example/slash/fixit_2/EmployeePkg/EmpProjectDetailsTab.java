...
public class EmpProjectDetailsTab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emp_project_details_tab);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch(position){
                ...
                case 1:
                    EmpIssueList empIssueList = new EmpIssueList();
                    return empIssueList;
            }
            return null;
        }
