...
public class EmpProfile extends AppCompatActivity {
    ...
    String getProjectDataUrl = "http://fixit.projects.mrt.ac.lk/Fixit/profile_view_emp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManager sessionManager = new SessionManager(EmpProfile.this);
    ...
    public void sendData()
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, sendDataUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                {
                    Toast.makeText(EmpProfile.this,"Operation Sussessfull!",Toast.LENGTH_LONG).show();
                }
                else
                {
                    Toast.makeText(EmpProfile.this,"Operation Failed!",Toast.LENGTH_LONG).show();
                }
            }
        ...
        MySingleton.getInstance(EmpProfile.this).addToRequestQueue(stringRequest);
