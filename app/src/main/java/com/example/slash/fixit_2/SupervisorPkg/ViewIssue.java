...
public class ViewIssue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ViewIssue.this,pId+"  "+issueName+" "+description,Toast.LENGTH_LONG).show();
        ...
        MySingleton.getInstance(ViewIssue.this).addToRequestQueue(stringRequest);
...
//        MySingleton.getInstance(ViewIssue.this).addToRequestQueue(stringRequest1);
        ...
        viewImageBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ViewIssue.this,ViewImagePopUp.class);
                Bundle bundle = new Bundle();
    ...
    public void getProgress()
    {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getProgressUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                adapter = new ArrayAdapter<String>(ViewIssue.this,android.R.layout.simple_list_item_1,progressList);
